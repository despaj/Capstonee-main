...
router.get("/notifications/low-stock-items", authorize("Super Admin", "Franchisee Operations Admin", "Sales Admin", "Manager", "Staff", "Franchisee"), async (req, res) => {
...
router.get("/notifications", authorize("Super Admin", "Franchisee Operations Admin", "Sales Admin", "Manager", "Staff", "Franchisee"), async (req, res) => {
  const { userId } = req.query;
  try {
    const result = await pool.query(
...
router.patch("/notifications/:id/read", authorize("Super Admin", "Franchisee Operations Admin", "Sales Admin", "Manager", "Staff", "Franchisee"), async (req, res) => {
  try {
...
router.patch("/notifications/read-all", authorize("Super Admin", "Franchisee Operations Admin", "Sales Admin", "Manager", "Staff", "Franchisee"), async (req, res) => {
...
router.post("/notifications/check-low-stock", authorize("Super Admin", "Franchisee Operations Admin", "Sales Admin", "Manager", "Staff"), async (req, res) => {
  const { userId } = req.body;
  try {
    const userResult = await pool.query(
      "SELECT branch FROM users WHERE id=$1",
