    ...
    <>
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-change positive">↑ 15% growth</div>
        </div>
      ...
      <div className="section">
        ...
        <div style={{ padding: '1rem 0' }}>
          <p style={{ color: 'var(--gray-600)', lineHeight: '1.8' }}>
            • New inventory shipment received (Jan 30, 2026)<br />
            • Monthly sales report generated (Jan 28, 2026)<br />
            • Low stock alert: Amoxicillin 250mg (Jan 27, 2026)
          </p>
        </div>
      </div>
    </>
...
function InventorySummaryContent({ user }) {
  ...
  useEffect(() => {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/inventory${query}`)
      .then(r => r.json())
