...
function BrandOverviewCard({ brandDef, brandObj, items, onClick }) {
  ...
  return (
    <div
      ...
      onClick={onClick}
      style={{
        textAlign:"left", width:"100%", minWidth:0, minHeight:148, height:"auto", padding:0, appearance:"none",
        display:"flex", flexDirection:"column", alignItems:"stretch", justifyContent:"flex-start", gap:0,
    ...
    >
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(3,minmax(0,1fr))", width:"100%", minHeight:71, boxSizing:"border-box", gap:8, padding:"16px 18px" }}>
